		   ...
		   <div class="layui-form-item">
		    ...
		    <c:choose>
		     <c:when test = "${requestScope.doctor != null }">
		      <input type="text" id="username" name="username" value="${requestScope.doctor.user.username}" disabled lay-verify="required" placeholder="请输入登录名" autocomplete="off" class="layui-input" style="width: 500px;">
		    </c:when>
		    <c:otherwise>
		    <input type="text" id="username" name="username" value="${requestScope.doctor.user.username}"  lay-verify="required" placeholder="请输入登录名" autocomplete="off" class="layui-input" style="width: 500px;">
		    </c:otherwise>
		    </c:choose>
		    </div>
		  </div>
