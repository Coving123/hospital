...
<form class="layui-form" action="">
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="did" value="${requestScope.appointMent.doctor.name }" placeholder="请输入医生姓名" autocomplete="off" class="layui-input" style="width: 500px;" readonly>
    </div>
  </div>
   <div class="layui-form-item">
    <label class="layui-form-label">患者姓名</label>
    <div class="layui-input-block">
      <input type="text" name="pid" value="${requestScope.appointMent.patient.name }" placeholder="请输入患者姓名" autocomplete="off" class="layui-input" style="width: 500px;" readonly>
    </div>
  </div>
  <div class="layui-form-item layui-form-text">
    <label class="layui-form-label">情况简述</label>
    <div class="layui-input-block">
      <textarea name="desc" placeholder="请输入情况简述" class="layui-textarea" readonly>${requestScope.appointMent.description }</textarea>
    </div>
  </div>
  <div class="layui-form-item layui-form-text">
    <label class="layui-form-label">生效日期</label>
    <div class="layui-input-block">
     <input type="text" value="${requestScope.appointMent.effectDate }" placeholder="请输入生效日期" autocomplete="off" class="layui-input" style="width: 500px;" readonly>
    </div>
  </div>
  <div class="layui-form-item">
    <div class="layui-input-block">
