layui.use(['form','layer','laydate','table','upload'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'nid', title: '编号', minWidth:125},
    ...
    $(".delAll_btn").click(function(){
        ...
        if(data.length > 0) {
            ...
            layer.confirm('确定删除选中的护士信息？', {icon: 3, title: '提示信息'}, function (index) {
                 $.get("removeNurseById.do",{
                     nid : data.nid  //将需要删除的nid作为参数传入
                 },function(data){
                tableIns.reload();
                layer.close(index);
                 })
